...
$(document).ready(function(){
  $(document).on("mousedown", "#record:not(.disabled)", function(){//touchstart
  ...
  // reset
  $(document).bind("mouseout", "#record:not(.disabled)", function(){ //touchleave
  ...
  // submit recording 
  $(document).bind("mouseup", "#record:not(.disabled)", function(){ //touchend
