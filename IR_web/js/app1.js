...
$(document).ready(function(){
  $(document).on("touchstart", "#record:not(.disabled)", function(){//touchstart mobile / mousedown web
  ...
  // reset
  $(document).bind("touchleave", "#record:not(.disabled)", function(){ //touchleave mobile / mouseout web
  ...
  // submit recording 
  $(document).bind("touchend", "#record:not(.disabled)", function(){ //touchend mobile / mouseup web
